...
import com.kokoharry.common.util.CodeGenrateUtil;
import com.kokoharry.common.util.RoleUtil;
import com.kokoharry.common.util.ZipUtil;
...
public class CodeGenrateController extends BaseController {
    ...
    public void uploadSql(HttpServletRequest request, HttpServletResponse response, @RequestParam(value = "inputSql",
        ...
        try {
            ...
            //创建完成了临时表
            try {
                List<File> list = CodeGenrateUtil.process(genrateScope,codeGenrateService.getTablesAndColumns
                        (tableName),tableName,realPath);
                //6.创建zip文件
    ...
    public void table2Code(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            //创建完成了临时表
            try {
                List<File> list = CodeGenrateUtil.process(genrateScope,
